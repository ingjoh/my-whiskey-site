...
*   Supports client-side high-resolution media batch packaging (`JSZip`), enabling guests to archive and download full-quality excursion photos, videos, and narrative story summaries into a local `.zip` file.
